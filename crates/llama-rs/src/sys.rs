...
extern "C" {
    ...
    pub fn llama_memory_clear(mem: llama_memory_t, clear_all: bool);
    pub fn llama_get_memory(ctx: *mut llama_context) -> llama_memory_t;
}
...
impl Default for llama_sampler_chain_params {
    fn default() -> Self {
        Self { no_perf: true }
    }
}
