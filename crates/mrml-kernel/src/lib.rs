...
pub use virtual_gpu::{
    ...
    GpuVmmMemory, GpuVmmQueueBridge, GpuVmmQueueError, KernelId, MAX_ACTIVE_EXPERTS,
    MAX_BATCH_DISPATCHES, MAX_DISPATCH_BUFFERS, MAX_DISPATCH_SCALARS, MAX_GPU_CONTROL_BYTES,
    MAX_GPU_QUEUE_SLOTS, MediatedGpuExecutor, PreparedGpuBatch, PreparedGpuDispatch,
