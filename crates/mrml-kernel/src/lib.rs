...
pub use virtual_gpu::{
    ...
    GpuSubmitError, KernelId, MAX_ACTIVE_EXPERTS, MAX_BATCH_DISPATCHES, MAX_DISPATCH_BUFFERS,
    ...
    VerifiedGpuKernelBundle, VirtualGpuSession, process_gpu_resource_command, submit_gpu_batch,
