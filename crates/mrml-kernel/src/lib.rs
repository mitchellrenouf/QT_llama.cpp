...
pub use virtual_gpu::{
    ...
    GpuCompletion, GpuCompletionReceiver, GpuCompletionRing, GpuCompletionSender,
    GpuCompletionStatus, GpuDispatchBatch, GpuError, GpuHostBackend, GpuLifecycleError,
    GpuQueueReceiver, GpuQueueSender, GpuRingConsumer, GpuRingProducer, GpuRingTicket,
    GpuSharedQueueLayout, GpuSharedRingIndices, GpuSubmitError, KernelId, MAX_ACTIVE_EXPERTS,
