...
pub use virtual_gpu::{
    ...
    GpuDispatchBatch, GpuError, GpuHostBackend, GpuLifecycleError, GpuQueueReceiver,
    GpuQueueSender, GpuRingConsumer, GpuRingProducer, GpuRingTicket, GpuSharedQueueLayout,
    GpuSharedRingIndices, GpuSubmitError, KernelId, MAX_ACTIVE_EXPERTS, MAX_BATCH_DISPATCHES,
    ...
    ValidatedMoeKernelLaunch, VerifiedGpuKernelBundle, VirtualGpuSession, submit_gpu_batch,
