...
pub use virtual_gpu::{
    ...
    MAX_DISPATCH_BUFFERS, MAX_DISPATCH_SCALARS, MAX_GPU_CONTROL_BYTES, MAX_GPU_QUEUE_SLOTS,
    MediatedGpuExecutor, PreparedGpuBatch, PreparedGpuDispatch, ResourceCommand, ScalarArg,
    ScalarKind, ValidatedExpertSelection, ValidatedGpuBatch, ValidatedKernelLaunch,
    ValidatedMoeKernelLaunch, VerifiedGpuKernelBundle, VirtualGpuSession,
    process_gpu_resource_command, process_gpu_resource_command_with_response, submit_gpu_batch,
